...
if (empty($resources)) {
    ...
    $theHTML .= '</li>';
    $theHTML .= '<li id="2">';
    $theHTML .= '<input type="text" value="e.g. Monday 10:30 AM" onclick="if(this.value==\'e.g. Monday 10:30 AM\'){this.value=\'\';}">';
    ...
    $theHTML .= '</li>';
    $theHTML .= '<li id="3">';
    $theHTML .= '<input type="text" value="e.g. Monday 10:45 AM" onclick="if(this.value==\'e.g. Monday 10:45 AM\'){this.value=\'\';}">';
...
<div style="text-align:center;"><input type="button" id="saveButton" onclick="saveTimeSlots(<?php echo $problem['id'] ?>, 1);" value="Save"><input type="button" onclick="window.location='../../problems.php'" value="Discard Changes"></div>
