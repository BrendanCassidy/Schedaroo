...
var skinableCursor = {
	...
	skinPath : '<?php echo URL images/joey.cur',
    ...
    cursor : {
		lt : { x : '0px',	y : '0px',	w : '40px',	h : '40px' ,	dx : 0,	dy : 0 },
		rt : { x : '16px',	y : '0px',	w : '0px',	h : '0px' ,	dx : 16,	dy : 0 },
		rb : { x : '16px',	y : '16px',	w : '0px',	h : '0px' ,	dx : 16,		dy : 16 },
		lb : { x : '0px',	y : '16px',	w : '0px',	h : '0px' ,	dx : 0,	dy : 16 }
	},
    ...
    */
	...
	domReady : function () {
		...
		if ( skinableCursor.FF || skinableCursor.OP ) {
			...
			s.innerHTML = '* { cursor: inherit; } html { height: 100%; } body, html { cursor: none; }';
